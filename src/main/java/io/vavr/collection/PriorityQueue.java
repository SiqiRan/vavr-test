...
public final class PriorityQueue<T> extends AbstractQueue<T, PriorityQueue<T>> implements Serializable, Ordered<T> {
    ...
    public static <T extends Comparable<? super T>> PriorityQueue<T> of(T... elements) {
        return ofAll(Comparators.naturalComparator(), List.of(elements));
    }
    ...
    public static <T extends Comparable<? super T>> PriorityQueue<T> ofAll(java.util.stream.Stream<? extends T> javaStream) {
        return ofAll(Comparators.naturalComparator(), Iterator.ofAll(javaStream.iterator()));
    }
    ...
    public static <T> PriorityQueue<T> fill(int size, T element) {
        final Comparator<? super T> comparator = Comparators.naturalComparator();
        return Collections.fillObject(size, element, empty(comparator), values -> ofAll(comparator, List.of(values)));
    }
    ...
    public <U> PriorityQueue<U> scanLeft(U zero, BiFunction<? super U, ? super T, ? extends U> operation) {
        return Collections.scanLeft(this, zero, operation, it -> ofAll(Comparators.naturalComparator(), it));
    }

    @Override
    public <U> PriorityQueue<U> scanRight(U zero, BiFunction<? super T, ? super U, ? extends U> operation) {
        return Collections.scanRight(this, zero, operation, it -> ofAll(Comparators.naturalComparator(), it));
    }
