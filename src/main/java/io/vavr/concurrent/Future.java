...
public interface Future<T> extends Value<T> {
     ...
     * {@link java.util.stream.Stream#parallel()} and {@link CompletableFuture}}</li>
     * </ul>
     *
    ...
    /**
     * Creates a {@code Future} with the given {@link CompletableFuture}, backed by the {@link #DEFAULT_EXECUTOR}
     *
     * @param future A {@link CompletableFuture}
     * @param <T>    Result type of the Future
     * @return A new {@code Future} wrapping the result of the {@link CompletableFuture}
     * @throws NullPointerException if future is null
     */
    @GwtIncompatible
    ...
    /**
     * Creates a {@code Future} with the given {@link CompletableFuture}, backed by given {@link Executor}
     *
     * @param executor An {@link Executor}.
     * @param future   A {@link CompletableFuture}.
     * @param <T>      Result type of the Future
