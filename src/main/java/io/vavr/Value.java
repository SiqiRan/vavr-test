...
public interface Value<T> extends Iterable<T> {
     ...
     *
     * @return true if this {@code Value} is async (like {@link Future}), false otherwise.
     */
    boolean isAsync();
    ...
    /**
     * Converts this to a specific mutable {@link Collection} of type {@code C}.
     * Elements are added by calling {@link Collection#add(Object)}.
     *
     * <pre>{@code
     * // = []
     * Future.<String> of(() -> { throw new Error(); })
